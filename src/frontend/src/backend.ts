...
export class Backend implements backendInterface {
    ...
    async addSubmission(arg0: string, arg1: string, arg2: string, arg3: string): Promise<ContactSubmission> {
        if (this.processError) {
            try {
                const result = await this.actor.addSubmission(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async incrementCounter(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.incrementCounter();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
